...
date: '2020-05-07'
tags: ['typescript', 'node.js', 'rest api', 'express', 'mysql']
published: true
---
...
![folder structure](/images/2020-05-07/folder_structure.png)
...
![start app](/images/2020-05-07/start_app.png)
...
![create player](/images/2020-05-07/create.png)

ลองเพิ่มอีกสัก 2-3 คนนะครับ แล้วไปเช็คที่ database ดู

![mysql](/images/2020-05-07/mysql.png)
...
![Get player](/images/2020-05-07/read.png)
...
![update player](/images/2020-05-07/update.png)

![update sql](/images/2020-05-07/update_sql.png)
...
![delete player](/images/2020-05-07/delete_method.png)

ลองเช็คดูว่าหายมั้ย

![delete sql](/images/2020-05-07/delete_sql.png)
